...
('BLUE SKY','Beef Patty + Blue Cheese + Bacon + Sweet Onion Marmalade + Lettuce + Tomato + Pickles',1),
('FRESH MORNING','Beef Patty + American Cheese + Fried Egg + brgr Sauce + Grilled Onions + Lettuce + Tomato',1),
('DOWN ON THE FARM','Beef Patty + Cheddar + Bacon + Horseradish Sauce + Onion + Lettuce + Tomato + Pickles',1),
